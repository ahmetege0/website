        ...
        <main className="min-h-screen flex items-center justify-center px-6" style={{ background: "var(--bg)" }}>
            ...
            >
                ...
                <h1 className="text-3xl font-black mb-3" style={{ color: "var(--text)" }}>
                    {lang === "tr" ? "Müzikler" : "Music"}
                </h1>

                {/* Alt yazı */}
                <p className="text-base leading-relaxed mb-8" style={{ color: "var(--text-muted)" }}>
                    {lang === "tr"
                        ? "Bu sayfa şu an geliştiriliyor. Çalma listesi ve favoriler yakında burada olacak."
                        : "This page is under construction. Playlists and favorites will be here soon."}
                </p>
